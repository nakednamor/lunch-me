...
void main() {
  ...
  test('should throw exception when new tag-group name is empty', () async {
    ...
    // expect
    expect(() => dao.addTagGroup(newTagGroupName),
  ...
  test('should rename tag-group', () async {
    ...
    await testDatabase.tagGroupDao
        .renameTagGroup(tagGroup.id, newTagGroupName, localeEnglish);
  ...
  test(
    ...
    // expect
    expect(() => dao.renameTagGroup(tagGroup.id, '', localeEnglish),
        throwsA(isA<EmptyNameException>()));
  });
  ...
  test(
    ...
    // expect
    expect(
        () => dao.renameTagGroup(tagGroup.id, newTagGroupName, localeEnglish),
        throwsA(isA<NameTooLongException>()));
  });
  ...
  test(
    ...
    // expect
    expect(
        () => dao.renameTagGroup(tagGroup.id, 'first tag-group', localeEnglish),
        throwsA(isA<NameAlreadyExistsException>()));
  });
